...
_COMMANDS = [
    ...
    {"command": "clone",      "description": "Clone entire chat with link rewriting"},
    {"command": "pinned",     "description": "Save pinned messages from a chat"},
    ...
    {"command": "status",     "description": "Check userbot connection and session status"},
